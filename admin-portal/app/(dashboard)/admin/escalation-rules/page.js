...
export default function EscalationRulesPage() {
  ...
  const load = () => Promise.all([api.get("/admin/escalation-rules"), api.get("/admin/escalation-logs")]).then(([rulesRes, logsRes]) => {
  ...
  if (isLoading) return <CenteredLoader label="Loading escalations..." />;
