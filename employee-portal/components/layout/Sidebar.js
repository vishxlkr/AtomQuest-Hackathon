   ...
   return (
      <aside className="fixed left-0 top-0 z-40 flex h-screen w-[220px] flex-col border-r border-white/5 bg-[#0d0d14]">
                  ...
                  return (
                     ...
                     >
                        ...
                        {label === "Notifications" && unreadCount > 0 ? (
                           <span className="ml-auto min-w-[18px] rounded-full bg-indigo-600 px-1.5 py-0.5 text-center text-[10px] font-semibold text-white">
                              {unreadCount}
                           </span>
                        ) : null}
                     </Link>
         ...
         <div className="border-t border-white/5 px-3 pb-4 pt-3">
            <div
               onClick={logout}
               className="group flex cursor-pointer items-center gap-2.5 rounded-lg px-2 py-2 transition-colors hover:bg-white/5"
               role="button"
               tabIndex={0}
               aria-label="Logout"
               onKeyDown={(e) => {
            ...
            >
               ...
               <div className="flex-shrink-0 text-slate-600 transition-colors group-hover:text-slate-400 pointer-events-none">
                  <LogOut size={13} />
               </div>
            </div>
         </div>
